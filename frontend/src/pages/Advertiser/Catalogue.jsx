...
import { websiteService, searchService ,cartService } from "../../utils/services";
...
const Catalog = () => {
  ...
  const handleAddToCart = async (userId, websiteId) => {
    try {
      ...
      updateCartCount(userId); // Update cart count after adding item
                    ...
                    >
                      <td className="sticky left-0 z-10 p-3 bg-white">
                        <div className="flex gap-2">
                          ...
                          className="p-2 bg-foundations-primary rounded-full text-white hover:bg-foundations-secondary transition-colors"
                          onClick={() =>
                            handleAddToCart(item.userId, item._id) // 🛠 Step 4: Call handleAddToCart
                          }
                        >
                          <FaShoppingCart />
                        </button>
