...
//       }
//       // Remove the logout logic from here
//     } catch (error) {
...
//     try {
//       const lastLogin = useAuthStore.getState().lastLogin; // Fetch `lastLogin` from Auth Store
//       const now = new Date();
//       const oneDayInMs = 24 * 60 * 60 * 1000;

//       // Check if the user logged in more than one day ago
...
//         );
//         await useAuthStore.getState().logout(); // Logout the user
//         return;
//       }
...
//         // Update local state and trigger logout
//         setEmail(newEmail);
...
//   <h2 className="text-xl font-semibold text-gray-800">Invoicing Accounts</h2>
